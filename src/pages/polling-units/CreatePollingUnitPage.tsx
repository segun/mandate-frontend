...
export function CreatePollingUnitPage() {
  ...
  // Tenant polling units already added (by geoPollingUnitId)
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-[#888] mt-1">Select polling units from the reference database to add to your tenant</p>
        </div>
        <button
          type="button"
          onClick={() => navigate(-1)}
