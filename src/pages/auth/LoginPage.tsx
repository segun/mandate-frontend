...
export function LoginPage() {
    ...
    return (
        <div
            className="min-h-screen flex items-center justify-center bg-[#0d0d0f] px-4"
            style={{
                background:
                    "radial-gradient(ellipse at bottom, rgba(202, 138, 4, 0.1) 0%, #0d0d0f 50%)",
            }}
        >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="w-full">
                        ...
                        <p className="mt-2 text-xs text-[#888]">
                            Complete captcha to enable login.
                        </p>
                    </div>
