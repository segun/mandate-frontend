(() => {
    ...
    t.register("iM5Ye", (function(e, i) {
        ...
        class m {
            ...
            h(a)
            {
                ...
                const e = this.o[0],
                    i = this.o.at(-1);
                this.i && e && i && a.startTime - i.startTime < 1e3 && a.startTime - e.startTime < 5e3 ? (this.i += a.value, this.o.push(a)) : (this.i = a.value, this.o = [a]),
                this.t?.(a)
            }
        }
        const d = (a, e, i={}) => {
        ...
        const f = () => "hidden" !== document.visibilityState || document.prerendering ? 1 / 0 : 0,
            ...
            M = (a, e={}) => {
                y((() => {
                    ...
                    const u = d("paint", (a => {
                        for (const e of a)
                            "first-contentful-paint" === e.name && (u.disconnect(), e.startTime < i.firstHiddenTime && (c.value = Math.max(e.startTime - s(), 0), c.entries.push(e), r(!0)))
                    }));
        ...
        const B = a => {
            for (const e of a)
                e.interactionId && (R = Math.min(R, e.interactionId), U = Math.max(U, e.interactionId), b = U ? (U - R) / 7 + 1 : 0)
        };
        let k;
                ...
                y((() => {
                    ...
                    const u = l(e, G),
                        m = a => {
                            ...
                            for (const e of a)
                                u.h(e),
                                e.startTime < i.firstHiddenTime && (c.value = Math.max(e.startTime - s(), 0), c.entries = [e], r())
                        },
    ...
    function() {
        ...
        if (document.currentScript) {
            if (s = document.currentScript.getAttribute("data-host"), n = document.currentScript.getAttribute("data-proxy"), o = document.currentScript.getAttribute("data-proxy-url"), c = document.currentScript.getAttribute("data-token"), A = document.currentScript.getAttribute("data-domain"), n && o)
                throw console.error("Error: Both data-proxy and data-proxy-url are specified. Please use only one of them."), new Error("Both data-proxy and data-proxy-url are specified. Please use only one of them.");
        ...
        async function v(a, e) {
            if (f(), (r = window.navigator.userAgent) && "string" == typeof r && r.length > 500)
                return;
            var r;
            let t,
                A;
            if (o ? t = o : n ? t = `${n}/api/tracking` : s ? (s = s.replaceAll(/\/+$/gm, ""), t = `${s}/v0/events?name=${i}&token=${c}`) : t = `https://api.tinybird.co/v0/events?name=${i}&token=${c}`, m) {
                if (A = S(e), A = Object.assign({}, JSON.parse(A), l), A = JSON.stringify(A), !h(A))
                    return
            } else {
                A = Object.assign({}, e, l);
                const a = S(A);
